...
$datamenu=$menu->paketmenu($id_paket,$posisi,$batas);
$datapaketmenu = $paket->detail($id_paket);
$datapaket = $paket->tampil();
$nama_paket=$datapaketmenu['nama_paket'];
		...
		<div class="container">
			...
			<div class="row">
				<div class="alert alert-dark" style="background: #E8E8E8;">
					<b><h4 style="color: #202020;">Paket Menu &nbsp "<?php echo $nama_paket; ?>"</h4></b>
				</div>
				<?php if (empty($datamenu)): ?>
					<div id="aside" class="col-md-3">
						<div class="aside">
							<h3 class="aside-title">Paket Menu</h3>
								...
								<?php foreach ($datapaket as $key => $value): ?>
									...
									<div class="input-checkbox">
										...
										<label for="category-1">
											<span></span>
											<a href="paketmenu?id=<?= $value['id_paket']; ?>"><?= $value['nama_paket']; ?></a>
										</label>
									</div>
								<?php endforeach ?>
							</div>
									...
									<?php else: ?>
										<div class="product-widget">
											...
											<div class="product-body">
												<p class="product-category"><?php echo $value['nama_paket']; ?> 
					...
					<div class="col-md-9">
						<center>
							<div class="amplebiz-errorpage" style="width: 99%;">  
								...
								<br />
								<em>Maaf, Paket menu "<?php echo $nama_paket ?>" belum tersedia. </em>
									...
									<?php foreach ($datamenu as $key => $value): ?>
										<div class="col-md-3 col-xs-6">
											<div class="product">
												...
												<div class="product-body">
													<p class="product-category"><?= $value['nama_paket']; ?></p>
                ...
                <?php 
                $id_paket = $_GET['id'];
                $banyakproduk=$menu->semuamenu($id_paket);
                ...
                for($i = $start_number; $i <= $end_number; $i++){
                	...
                	?>
                	<li<?php echo $link_active; ?>><a href="produkkategori?id=<?= $id_kategori; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                	<?php
                }
                ?>
                ...
                if($page == $banyakpage){ // Jika page terakhir
                	...
                	?>
                	<li><a href="produkkategori?id=<?= $id_kategori; ?>&page=<?php echo $link_next; ?>"><i class="fa fa-angle-double-right"></i></a></li>
                	<li><a href="produkkategori?id=<?= $id_kategori; ?>&page=<?php echo $banyakpage; ?>">Last</a></li>
                	<?php
                }
                ?>
            </ul>
