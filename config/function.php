...
function smtp_mail($to, $subject, $message, $from_name, $from, $cc, $bcc, $debug=false) {
  ...
  $mail->SMTPAuth 	= true;                        				
  $mail->Host 		  = 'mail.marwahcatering.com';  // Masukkan Server SMTP
  $mail->Port 		  = 587;                                      // Masukkan Port SMTP
  $mail->SMTPSecure = 'tls';                                    // Masukkan Pilihan Enkripsi ( `tls` atau `ssl` )
  $mail->Username 	= 'support@marwahcatering.com';                // Masukkan Email yang digunakan selama proses pengiriman email via SMTP
  $mail->Password 	= '152ab4026catering';        						          // Masukkan Password dari Email tsb
  $default_email_from       = 'support@marwahcatering.com';        // Masukkan default from pada email
  $default_email_from_name  = 'Marwah Catering';           // Masukkan default nama dari from pada email
