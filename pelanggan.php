					...
					<div class="popular-posts-area">
						<div class="row">
							...
							<ul class="list-group" style="margin-top: 15px;">
								<li class="list-group-item"><p><a href="pelanggan.php?page=profil"><img width="40" class="packing" src="img/profilsaya.png" alt="">&nbsp;&nbsp; <strong>Profil Saya</strong></a></p></li>
								<li class="list-group-item"><p><a href="pelanggan.php?page=pesanan"><img width="40" class="packing" src="img/pesanansaya.png" alt="">&nbsp;&nbsp; <strong>Pesanan Saya</strong></a></p></li>
		...
		<div class="modal fade" id="modaleditprofil">
			...
			<script type="text/javascript">
				...
				(function(){
					...
					s1.async=true;
					s1.src='https://embed.tawk.to/5dde73f2d96992700fc9807c/default';
					s1.charset='UTF-8';
