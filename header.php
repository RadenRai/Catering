	...
	<div id="top-header">
		<div class="container">
			<ul class="header-links pull-left">
				...
				<li><a href="https://www.instagram.com/shofa_marwahcatering/" target="blank"><i class="fa fa-instagram"></i></a></li>
				<li><a href="https://www.google.com/maps/place/UD.+Catering+Marwah/@-7.7736151,110.3331174,17z/data=!3m1!4b1!4m5!3m4!1s0x2e7a5874685aae5d:0x66529f5de1671ade!8m2!3d-7.7736204!4d110.3353061" target="blank"><i class="fa fa-map-marker"></i></a></li>
			</ul>
										...
										<?php foreach ($datakeranjang as $key => $value) : ?>
											...
											<div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty"><?php echo $value['jumlah']; ?>x</span>Rp. <?= number_format($value['harga_menu']); ?></h4>
												</div>
												<a href="<?php echo $base_url; ?>hapuskeranjang.php?id=<?php echo $value['id_menu']; ?>" class="delete"><i class="fa fa-close"></i></a>
											</div>
										<?php endforeach ?>
									</div>
				...
				<?php if (isset($_SESSION['pelanggan'])) : ?>
					<li class="dropdown user user-menu" style=" z-index: 10;"><a href="" class="not-active">
						...
						<ul class="dropdown-content">
							...
							<li><a href="<?php echo $base_url; ?>logout" style="color: #3eac47;"><i class="fa fa-sign-out"></i> Logout</a></li>
						</ul>
					</li>
				<?php endif ?>
				<?php if (!isset($_SESSION['pelanggan'])) : ?>
