...
<body>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-7">
						...
						<table class="table table-striped">
							<tbody>
								...
								<?php foreach ($datakeranjang as $key => $value) : ?>
									...
									<tr>
										<td width="15%">
											<center><img width="80" src="admin/upload/img-menu/<?= $value['gambar_menu']; ?>" alt=""></center>
										</td>
										<td>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="input" type="text" name="nama" value="<?= $datapelanggan['nama'] ?>" placeholder="Nama Lengkap" required="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="">Telepon</label>
										<input class="input" type="number" name="telp" value="<?= $datapelanggan['telepon'] ?>" placeholder="Telepon" required="">
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="">Alamat Lengkap</label>
								<textarea name="alamat" class="input" placeholder="Alamat lengkap" minlength="20" maxlength="200" required=""><?= $datapelanggan['alamat'] ?></textarea>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select id="sub" class="form-control" name="sub"  required="">
											<?php
											$query = mysqli_query($mysqli, "SELECT * FROM ongkir INNER JOIN ongkirket ON ongkirket.id_ongkirket = ongkir.id_ongkirket ORDER BY kabupaten");
											while ($row = mysqli_fetch_array($query)) { ?>

												<option id="sub" class="<?php echo $row['id_ongkirket']; ?>" value="<?php echo $row['id_ongkir']; ?>" biaya="<?php echo $row['ongkos_kirim']; ?>">
													<?php echo $row['kabupaten']; ?> / Rp .<?php echo $row['ongkos_kirim']; ?>
												</option>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<div class="input-group">
											<input type='text' id="second" name="tanggal_aa" class="form-control" placeholder="YYYY-MM-DD"  required="" />
					...
					<input type="hidden" name="biaya_paket">
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-col">
								...
								<div><strong class="order-total" style="font-size: 18px;">Rp. <?= number_format($totalbelanja) ?> </strong></div>
							</div>
							<hr>
							...
							<div class="order-col">
								...
								<div><strong class="order-total" id="total_bayar" style="font-size: 18px;">Rp. </strong></div>
							</div>
						</div>
		...
		{
			$id_pesanan = $pesanan->checkout($_POST['nama'], $_POST['telp'], $_POST['alamat'], $_POST['paket'], $_POST['tanggal_aa'], $_POST['jam_aa'], $_POST['biaya_paket'], $_POST['total_belanja']);
			echo "<script>alert('Terima kasih telah melakukan pesanan, anda akan kami alihkan ke halaman info pembayaran');</script>";
			echo "<script>location='deadline.php?id=$id_pesanan';</script>";
		}
		?>
