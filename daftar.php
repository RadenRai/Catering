...
<head>
	...
	<title>Daftar - Catering Bekasi</title>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<p class="text-center">Sudah mempunyai akun Luciffer Inc? <a href="login"><span style="color:#3eac47;">Masuk</span></a></p>
					<hr>
					<div class="panel-body">
						<form action="" method="post">
							...
							<div class="text-center">
								<button style="background: linear-gradient(to bottom, #3eac47 0%, #54d44e 100%); border-color: #3eac47;" class="btn btn-success btn-block" name="daftar"> Daftar</button>
							</div>
						</form>
						<?php
						...
						?>
						<hr>
						<div class="sudah">Dengan mendaftar, saya menyetujui <span style="color: #3eac47;"><a href="<?= $base_url; ?>syaratketentuan">Syarat & Ketentuan</a></span> serta <span style="color: #3eac47;"><a href="<?= $base_url; ?>kebijakanprivasi">Kebijakan Pribasi</a></span></div>
					</div>
				</div>
			</div>
		</div>
