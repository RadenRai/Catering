...
<!--    <div class="preloader">
    ...
    <div class="container">
        <div class="panel panel-default"> 
            ...
            <center><img src="img/logonota.png" alt=""></center>
            <hr>
                    ...
                    <div class="col-md-3 col-xs-3">
                        ...
                        <p>
                            <?php if ($detail['status_pesanan']=="Belum Bayar"): ?>
                              <span class="label label-danger">Pending DP</span>
                              <?php elseif ($detail['status_pesanan']=="Menunggu Konfirmasi Pelunasan"): ?>
                                  <span class="label label-warning">Menunggu Konfirmasi Pelunasan</span>
                                        ...
                                        <div class="row">
                                                ...
                                                <table class="table table-bordered table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($datanota as $key => $value): ?>
                                                            ...
                                                            <tr>
                                                                <td width="5%"><?= $key+1 ?></td>
                                                                <td><img width="70" src="admin/upload/img-menu/<?= $value['gambar_menu'] ?>" alt=""></td>
                                            ...
                                            <div class="row hidden-print">
                                                <div class="col-md-6 col-md-push-6 col-xs-6">
                                                    <a href="pelanggan?page=pesanan" class="btn btn-primary hidden-print"><i class="fa fa-file-text"></i> Riwayat Transaksi</a>
                                                    <?php if ($detail['status_pesanan']=="Belum Bayar"): ?>
                                                        <a href="carapembayaran?id=<?= $id_pesanan ?>" class="btn btn-success hidden-print" ><i class="fa fa-money"></i> Cara Pembayaran</a>
                                                        <?php else: ?>    
                                                        <?php endif ?>
                                                        <button onclick="window.print()" class="btn btn-info hidden-print"><i class="fa fa-print"></i> Cetak</button>
                                                    </div>
                                                    <div class="col-md-6 col-md-pull-6 col-xs-6 hidden-print">
                                                        <div class="alert alert-info">
                                                            ...
                                                            <?php if ($detail['status_pesanan']=="Menunggu Konfirmasi Pelunasan"): ?>
                                                                <p>
                                                                    Terima kasih telah melakukan pembayaran Pelunasan sebesar <strong>Rp. <?= number_format($detail['lunas']) ?></strong>. Mohon menunggu, kami sedang memproses pembayaran Anda paling lambat 1x24 Jam.
                                                                </p>
                                                                <?php elseif ($detail['status_pesanan']=="Selesai"): ?>
                                                                    <p>
                                                                    ...
                                                                    <?php elseif ($detail['status_pesanan']=="Pembayaran Ditolak"): ?>
                                                                        <p>
                                                                            <strong>Terimakasih telah melakukan pesanan</strong>. Pembayaran DP Anda kami tolak dengan alasan : <strong><?php echo $detail['alasan_tolak'] ?></strong>.
                                                                        </p>
                                                                        <?php elseif ($detail['status_pesanan']=="Pembayaran Pelunasan Ditolak"): ?>
                                                                            <p>
                                                                                <strong>Terimakasih telah melakukan pesanan</strong>. Pembayaran Pelunasan Anda kami tolak dengan alasan : <strong><?php echo $detail['alasan_tolak'] ?></strong>.
                                                                            </p>
                                                                            <?php elseif ($detail['status_pesanan']=="Belum Bayar"): ?>
                                                                               <p>
                                                                                <strong>Terimakasih telah melakukan pesanan</strong>, Untuk menyelesaikan proses pesanan Anda, silahkan melakukan pembayaran <strong>DP</strong> sebesar <strong>Rp. <?= number_format($detail['dp']) ?></strong>.
                                                                            </p>
                                                                            <hr>
                                                                            <ul>
                                                                                <li></li> 
                                                                            ...
                                                                            <?php elseif ($detail['status_pesanan']=="Proses"): ?>
                                                                               <p>
                                                                                <strong>Terimakasih telah melakukan pesanan</strong>, Pembayaran pelunasan untuk pesanan ini telah diterima, kami akan menginfokan jika pesanan sudah selesai</strong>.
                                                                            </p>
                                                                            <?php elseif ($detail['status_pesanan']=="Menunggu Konfirmasi"): ?>
                                                                                <p>
                                                                                    <strong>Terimakasih telah melakukan pesanan</strong>, Mohon menunggu kami sedang memproses pembayaran DP anda paling lambat 1x24 Jam</strong>.
                                                                                </p>
                                                                                <?php elseif ($detail['status_pesanan']=="Menunggu Pelunasan"): ?>
                                                                                    <p>
                                                                                        <strong>Terimakasih telah melakukan pesanan</strong>, Silahkan lakukan pelunasan sebesar <strong>Rp. <?= number_format($detail['lunas']) ?></strong> untuk menyelesaikan pesanan Anda.
                                                                                    </p>
                                                                                <?php endif ?>
<.
                                                                            </div>
