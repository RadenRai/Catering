    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            <div class="panel panel-body">
                ...
                <p class="b"><b>3. </b> Jika anda sudah mempunyai akun dan anda sudah login langkah selanjutnya, klik Menu Catering dan pilih paket yang ingin anda pesan!</p>
                ...
                <p class="b"><b>5. </b> Jika sudah sesuai dengan menu yang ingin anda pesan, langkah selanjutnya pilih paket menu mana yang ingin anda pesan! Masukan jumlah yang ingin anda pesan dan langkah selanjutnya masukan ke keranjang, didalam halaman keranjang anda dapat melihan pilihan paket menu yang anda pesan, jika anda ingin membeli lebih dari satu paket anda bisa klik Lanjutkan Belanja, jika tidak langsung saja dengan mengklik tombol Checkout untuk melakukan transaksi pesanan anda!</p>
                ...
                <p class="b"><b>8. </b> Pada halaman cara pembayaran anda akan diberitahu jumlah pembayaran yang harus dibayar, dan transfer ke salah satu rekening UD. Catering Marwah!</p>
