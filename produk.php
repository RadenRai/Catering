						...
						<?php foreach ($datakategori as $key => $value): ?>
							<div class="input-checkbox">
								...
								<label for="category-1">
									<span></span>
									<a href="produkkategori.php?id=<?php echo $value['id_kategori']; ?>"><?= $value['kategori']; ?></a>
								</label>
							</div>
						<?php endforeach ?>
					</div>
					...
					<?php foreach ($terlaris as $key => $value): ?>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category"><?php echo $value['kategori']; ?> 
									</p>
					...
					<?php foreach ($dataproduk as $key => $value): ?>
						<div class="col-md-3 col-xs-6">
							<div class="product">
								...
								<div class="product-body">
									<p class="product-category"><?= $value['kategori']; ?></p>
