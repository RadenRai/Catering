                                   ...
                                   <?php elseif ($status['status_pesanan']=="Proses"): ?>
                                       ...
                                       <?php elseif ($status['status_pesanan']=="Selesai"): ?>
                                        ...
                                        <?php if ($status['status_pembayaran']=="Menunggu Konfirmasi"): ?>
                                            <a href="index.php?halaman=terimapembayaran&id=<?= $status['id_pesanan'] ?>" class="btn btn-primary" onclick="return confirm('Apakah total pembayaran sudah sesuai ?')" style='background: #40b149; border-color: #40b149;'> <i class="fa fa-check"></i> Terima Pembayaran</a>
                                            ...
                                            <?php elseif ($status['status_pembayaran']=="Menunggu Konfirmasi Pelunasan"): ?>
                                                <a href="index.php?halaman=terimapembayaran2&id=<?= $status['id_pesanan'] ?>" class="btn btn-primary" onclick="return confirm('Apakah total pembayaran sudah sesuai ?')" style='background: #40b149; border-color: #40b149;'><i class="fa fa-check"></i> Terima Pembayaran</a>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-default"><i class="fa fa-times"></i>
                                                    Tolak Pemabayaran
                                                </button> 
                                            <?php endif ?>
