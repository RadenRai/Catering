...
<body class="materialdesign">
    <div class="wrapper-pro">
                ...
                <div class="sidebar-header">
                    ...
                    <div class="left-custom-menu-adp-wrap">
                        <ul class="nav navbar-nav left-sidebar-menu-pro">
                         ...
                         <?php if ($data['hak_akses']=="admin"): ?>
                             <li class="nav-item">
                                 <a href="index.php?halaman=paket" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-list"></i> <span class="mini-dn">Paket</span></a>
                             </li>
                             <li class="nav-item">
     ...
     else
     {
        ...
        {
            include 'paket/tambah.php';
        }
        elseif ($_GET['halaman']=="ubahpaket") 
        {
            include 'paket/ubah.php';
        }
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copy-right">
                    <p>Copyright &#169; 2019 Marwah Catering All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
