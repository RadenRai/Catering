                      ...
                      <div class="panel-heading">
                        ...
                        <form method="GET" action="laporan/terlaris.php" target="blank">
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <button class="btn btn-primary btn-block" style="background: #40b149; border-color: #40b149;" type="submit" style="float: left;"><i class="fa fa-print"></i> Cetak Menu Terlaris</button>
                              </div>
                            </div>
                          </div>
                        </form>
