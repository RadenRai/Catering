...
<body>
  <div id='contentwrapper' class='contentwrapper'>
    <div id="judul">
      <br />
      <br />
      <font size="+2">ANANDA CATERING </font><br />
      <font size="+2"><u>LAPORAN TRANSAKSI</u></font><br /><br />
      Bekasi<br />
      Hp. 08981189598 Email : info@catering.com Website : www.anandacatering.com
    ...
    <div class="container">
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
          <?php if (empty($data)) : ?>
            <tr>
              <td colspan="7">
                <p class="text-center">Tidak ada data untuk ditampilkan pada bulan dan tahun yang anda pilih.</p>
              </td>
            </tr>
          <?php else : ?>
            <?php
      ...
      <table width="100%">
        <tr>
          <td></td>
          <td width="200px">
            <p>Bekasi, <?php echo tanggal_indo(date("Y-m-d")); ?><br>
              Pemilik,</p>
            <br>
            <br>
            <br>
