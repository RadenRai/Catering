...
$dari=$_GET['dari'];
$sampai=$_GET['sampai'];
$data=$laporan->laporanpertanggal($dari,$sampai);
$tgl= date("Y-m-d");
?> 
...
<body>
  <div id='contentwrapper' class='contentwrapper'>
    <div id="judul">
      <br />
      <br />
      <font size="+2">MARWAH CATERIMG </font><br />
      <font size="+2"><u>LAPORAN TRANSAKSI</u></font><br /><br />
      Nogosaren, Nogotirto, Kec. Gamping, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55293<br />
      Hp.  08981189598 Email : info@marwahcatering.com Website : www.marwahcatering.com
