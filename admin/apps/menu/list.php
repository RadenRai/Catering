                ...
                <div class="sparkline13-list shadow-reset">
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <a href="index.php?halaman=tambahmenu" class="btn btn-primary" style="float: left; background: #40b149; border-color: #40b149;"><i class="fa fa-plus"></i> Tambah</a><br><br><br>
