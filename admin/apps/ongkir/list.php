                                        ...
                                        <tr>
                                            ...
                                            <td width="20%">
                                                <?php if ($value['keterangan']=="Diambil"): ?>
                                                    <a href="index.php?halaman=ubahbank&id=<?= $value['id_bank'] ?>" class="btn btn-default as disabled" style="background-color: #54d44e;"><i class="fa fa-info-circle"></i> No Action</a>
