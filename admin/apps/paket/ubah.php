                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="breadcome-heading">
                                <h1><i class="fa fa-list"></i> Ubah Paket</h1>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ul class="breadcome-menu">
                                ...
                                <li><span class="bread-blod">Ubah Paket</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="basic-login-inner">
                                        <form class="row" method="post" enctype="multipart/form-data">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="text" name="nama" value="<?= $detail['nama_paket'] ?>" required="">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <img width="100" src="../upload/img-paket/<?= $detail['gambar'] ?>" alt="">
                                                    </div>
                                                    <div class="col-md-9">
                                        ...
                                        {
                                            $paket->ubah($_POST['nama'],$_FILES['gambar'],$_POST['uraian'],$id_paket);
