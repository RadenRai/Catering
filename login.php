...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>Masuk - Marwah Catering Yogyakarta</title>
					...
					<div class="panel-body">
						<form action="" method="post">
							<div class="form-group">
								...
								<input type="text" name="email" class="form-control" placeholder="Silahkan masukan nomor ponsel atau email anda" required="">
							</div>
							<div class="form-group">
							...
							<div class="text-center">
								<button style="background: linear-gradient(to bottom, #3eac47 0%, #54d44e 100%); border-color: #40b149;" class="btn btn-success" name="login"> Masuk</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header text-center">
					...
					<br>
					<p>Masukan alamat email yang terdaftar pada Marwah Catering</p>
				</div>
