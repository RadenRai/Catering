        ...
        <div class="panel panel-default">
            <center>
                ...
                <div class="alert alert-warning pastikan">
                    <p>Pastikan untuk tidak menginformasikan bukti dan data pembayaran kepada pihak manapun kecuali Marwah Catering</p>
                </div>
            </center>
            ...
            <div class="paymen">
                <center>
                    <?php if ($detailharga['status_pesanan'] == "Belum Bayar") : ?>
                        <p>Jumlah DP yang harus Anda bayar sebesar : <strong style="color: #FF6636;">
                                <h2>Rp. <?= number_format($detailharga['dp']); ?></h2>
                            </strong> </p>
                    <?php elseif ($detailharga['status_pesanan'] == "Menunggu Pelunasan") : ?>
                        <p>Jumlah Pelunasan yang harus dibayar : <strong style="color: #FF6636;">
                                <h2>Rp. <?= number_format($detailharga['lunas']); ?></h2>
                            </strong> </p>
                    <?php endif ?>
                </center>
            </div>
